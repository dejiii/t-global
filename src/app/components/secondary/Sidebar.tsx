...
const Sidebar = () => {
  return (
    <div className="">
      <Link href="/" className="flex gap-2 text-[14px] px-[10px]">
      ...
      <Link
        href="/"
        className="flex gap-2 text-[14px] bg-lightGreen text-green bold rounded-[10px] px-[10px]"
      >
        <AddIcon />
        <span>My to do Protocols</span>
      </Link>
      <Link href="/" className="flex gap-2 text-[14px] px-[10px]">
        <svg
          xmlns="http://www.w3.org/2000/svg"
